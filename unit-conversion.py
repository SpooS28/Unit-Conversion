...
label_cm.grid(row=0, column=0, padx=5, pady=5, sticky="w")
entry_cm = tk.Entry(window)
entry_cm.grid(row=0, column=1, padx=5, pady=5)
button_cm = tk.Button(window, text="Convert", command=cm_to_feet)
button_cm.grid(row=0, column=2, padx=5, pady=5)
...
label_feet.grid(row=1, column=0, padx=5, pady=5, sticky="w")
...
button_feet.grid(row=1, column=2, padx=5, pady=5)
...
label_sqft.grid(row=2, column=0, padx=5, pady=5, sticky="w")
entry_sqft = tk.Entry(window)
entry_sqft.grid(row=2, column=1, padx=5, pady=5)
button_sqft = tk.Button(window, text="Convert", command=sqft_to_sqmtrs)
button_sqft.grid(row=2, column=2, padx=5, pady=5)
...
label_sqft_area.grid(row=3, column=0, padx=5, pady=5, sticky="w")
entry_sqft_area = tk.Entry(window)
entry_sqft_area.grid(row=3, column=1, padx=5, pady=5)
button_sqft_area = tk.Button(window, text="Convert", command=sqft_to_hectare_acres)
button_sqft_area.grid(row=3, column=2, padx=5, pady=5)
...
label_result .grid(row=4, columnspan=3, padx=5, pady=5)
window.mainloop()